...
public class OgnlCodeInsightSanityTest extends LightJavaCodeInsightFixtureTestCase {
  ...
  @NonNls
  private static final String EXTENSION = com.intellij.lang.ognl.OgnlFileType.INSTANCE.getDefaultExtension();

  @Override
  protected void setUp() throws Exception {
    super.setUp();

    CodeInsightTestFixtureImpl.associateExtensionTemporarily(com.intellij.lang.ognl.OgnlFileType.INSTANCE, EXTENSION, getTestRootDisposable());
  }

  @Override
  protected void tearDown() throws Exception {
    try {
      WriteAction.run(() -> FileTypeManager.getInstance().removeAssociatedExtension(com.intellij.lang.ognl.OgnlFileType.INSTANCE, EXTENSION));
    }
    catch (Throwable e) {
  ...
  public void testRandomActivity() {
    MadTestingUtil.enableAllInspections(getProject(), com.intellij.lang.ognl.OgnlLanguage.INSTANCE);
