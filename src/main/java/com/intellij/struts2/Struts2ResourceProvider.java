...
final class Struts2ResourceProvider implements StandardResourceProvider {
    ...
    private static void addDTDResource(@NonNls final String uri,
        ...
        registrar.addStdResource(uri, DTD_PATH + localFile, Struts2ResourceProvider.class.getClassLoader());
        registrar.addStdResource(id, DTD_PATH + localFile, Struts2ResourceProvider.class.getClassLoader());
    }
