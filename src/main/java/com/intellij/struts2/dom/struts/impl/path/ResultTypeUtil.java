...
/**
 * Resolves effective Struts result type names, including the framework default.
 */
public final class ResultTypeUtil {

  /**
   * Struts built-in default result type when none is declared on the package hierarchy.
   *
   ...
   */
  @Nullable
  public static String resolveEffectiveResultTypeName(@NotNull final HasResultType hasResultType) {
    ...
    final ResultType effectiveResultType = hasResultType.getEffectiveResultType();
