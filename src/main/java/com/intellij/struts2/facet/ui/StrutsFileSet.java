...
public class StrutsFileSet implements Disposable {
    ...
    private static final Function<StrutsFileSet, String> FILESET_NAME_FUNCTION = StrutsFileSet::getName;

    private static final Function<StrutsFileSet, String> FILESET_ID_FUNCTION = StrutsFileSet::getId;
